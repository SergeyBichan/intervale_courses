...
public class Runner {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(numOfPositiveAndSumOfNegativeByStream(arr)));
        System.out.println(Arrays.toString(numOfPositiveAndSumOfNegativeByStream(arr2)));
